...
const getCardData = () => {
  return [
    {
      id: 1,
      title: "Local Revenue Optimization",
      description: "Regional revenue optimization refers to efforts by local governments to maximize income through efficient management of local taxes, retributions, assets, and other legitimate revenue sources.",
      imageUrl: "./pendapatan.jpg",
      tags: ["Fiscal Management", "Local Revenue", "Public Finance"],
      link: "#"
    }
    // {
    //   id: 2,
...
const OptimalisasiPendapatanDaerah = () => {
   useEffect(() => {
    Aos.init({
    duration: 1000,
    once: true,
  ...
  return (
    <div className="py-12 grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-12 pt-30 pl-10 pr-10">
         <div className="flex flex-col items-start text-white space-y-6 max-w-xl pl-5 pt-18">
            ...
            <p data-aos = 'zoom-in'>
                Local revenue optimization is a systematic effort made by local governments to increase local financial revenues maximally and efficiently, through the management of potential existing revenue sources, both from local tax sources, levies, local property management results, and other legal revenues.            
            </p>
        </div>
      {cards.map((card) => (
...
export default OptimalisasiPendapatanDaerah;